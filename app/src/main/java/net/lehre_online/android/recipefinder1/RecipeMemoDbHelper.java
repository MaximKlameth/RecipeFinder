...
/**Diese Klasse dient zum Aufbau der Datenbank. Inklusive der Methoden zum erhalt der Daten auf der DB
 * @author Kevin Giesen
 * @version 05.07.2020
 */
public class RecipeMemoDbHelper extends SQLiteOpenHelper{
        ...
        //Variabeln der TABELLE REZEPT_ZUTATEN
        ...
        //Variabeln der Tabelle Mail Rezepte
        ...
        //CREATE Statement für Tabelle Rezept
        ...
        //CREATE Statement für Tabelle Zutaten
        ...
        //CREATE Statement für Tabelle Rezept_Zutaten
        ...
        //CREATE Statement für Tabelle Rezept_Mail
        ...
        //Methode zum erhalt einer Datenbank-Instanz
        public RecipeMemoDbHelper(Context context) {
            ...
            public void onCreate(SQLiteDatabase db) {
                try {
                    //SQL's zum erstellen der oben definierten Tabellen werden ausgeführt
        ...
        //Methode zum Löschen von Tabellen
            @Override
            public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            db.execSQL("DROP TABLE IF EXISTS " + TABLE_REZEPT + ";");
        }

        //Methode zum Erhalten aller Rezepte auf der DB
             public Cursor getAllRecipes(){
             SQLiteDatabase db = this.getWritableDatabase();
             //Statement welches alle Rezepte aus der Tabelle Rezept wiedergibt
             Cursor res = db.rawQuery("Select rez_id, rez_name from " + TABLE_REZEPT, null);
             return res;
        }

        //Methode zum Erhalt passender Rezepte zu den Zutaten
        //Zutaten werden dieser übergeben
        public Cursor getRecipeFit(String zut1, String zut2, String zut3, String zut4, String zut5 ){
            SQLiteDatabase db = this.getWritableDatabase();
            //Select Statement ausgeführt, welches  passende Rezepte einmal liefert, in welchem eine der angegebenen Zutaten enthalten ist
        ...
        //Methode zum Erhalt passender Zutaten zu einem Rezept
        //Das Rezept werden dieser übergeben
        public Cursor getZutatenFit(String rezept){
            SQLiteDatabase db = this.getWritableDatabase();
            //Select Statement ausgeführt, welches passende Zutaten zum Rezept liefert
        ...
        //Methode zum Erhalt einer passenden Beschreibung zu einem Rezept
        //Das Rezept werden dieser übergeben
        public Cursor getBeschreibung(String rezept){
            SQLiteDatabase db = this.getWritableDatabase();
            //Select Statement ausgeführt, welches passende Beschreibung zum Rezept liefert
            Cursor fitBez = db.rawQuery("Select rez_beschreibung from " + TABLE_REZEPT +
                                             " WHERE rez_name like '" + rezept + "';" , null);
            return fitBez;
        }

        //Methode zum Erhalt passender Rezepte zu einer Mail
        //Die Mail wird dieser übergeben
            public Cursor getRecipeMailFit(String mail){
                SQLiteDatabase db = this.getWritableDatabase();
                //Select Statement ausgeführt, welches passende Rezepte zur Mail findet
                Cursor fitRezMail = db.rawQuery("Select rez_name from " + TABLE_REZEPT + " Join " + TABLE_REZEPT_MAIL +
                                                     " ON rez_name = name_rez WHERE rez_mail like '" + mail + "';" , null);
                return fitRezMail;
            }

        //Methode abspeichern von Rezepten
        //Die Mail und das Rezept wird dieser übergeben
            public void safeRecipe(String mail, String rezeptid){
                SQLiteDatabase db = this.getWritableDatabase();
                Log.d(LOG_TAG, "Der Datensatz: " + mail + rezeptid + " wurde angelegt.");
                //Insert Statement ausgeführt, welches einen Eintrag in der Rezept_Mail Tabelle tätig
                //Über diese werden Rezepte mit Mails gematched
        ...
        //Ausführen der Insert Statetements für die Gerichte
        //Beim erstmaligen Starten der App ausgeführt
